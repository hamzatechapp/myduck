...
import 'package:myduck/views/home_page.dart';
    ...
    return Column(
      children: [
        ...
        Row(
          ...
          children: [
            _socialButton(Icons.video_library_rounded, Colors.black),
            _socialButton(Icons.close_rounded, Colors.black),
            _socialButton(Icons.facebook_rounded, const Color(0xFF1877F2)),
            _socialButton(Icons.camera_alt_rounded, const Color(0xFFE4405F)),
          ],
        ),
      ],
    );
